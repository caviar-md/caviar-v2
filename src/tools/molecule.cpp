...
namespace caviar2
{
  ...
  {
    Molecule::Molecule() {};
    Molecule::Molecule(Caviar2 *fptr) : caviar_{fptr}, part_of_a_molecule_group{false}, upper_level_molecule_group{nullptr},
    ...
    Molecule::Molecule(const Molecule &m) : atomic_bond{m.atomic_bond},
    ...
    void Molecule::set_caviar(Caviar2 *c)
    {
      caviar_ = c;
    }
    ...
    /*
      bool Molecule::read(caviar2::interpreter::Parser *parser)
      {
        FC_OBJECT_READ_INFO
        ...
        while (true)
        {
          ...
          else if (string_cmp(t, "add_atomic_bond") || string_cmp(t, "atomic_bond"))
          {
            ...
            if (b.id_1 == b.id_2)
              caviar_->log.error_all(FC_FILE_LINE_FUNC_PARSE, "bond indices cannot be similar.");
          ...
          else if (string_cmp(t, "add_atomic_angle") || string_cmp(t, "atomic_angle"))
          {
            ...
            if (b.id_1 == b.id_2 || b.id_1 == b.id_3 || b.id_2 == b.id_3)
              caviar_->log.error_all(FC_FILE_LINE_FUNC_PARSE, "angle indices cannot be similar.");
          ...
          else if (string_cmp(t, "add_atomic_properdihedral") || string_cmp(t, "atomic_properdihedral"))
          {
            ...
            if (b.id_1 == b.id_2 || b.id_1 == b.id_3 || b.id_1 == b.id_4 || b.id_2 == b.id_3 || b.id_2 == b.id_4 || b.id_3 == b.id_4)
              caviar_->log.error_all(FC_FILE_LINE_FUNC_PARSE, "properdihedral indices cannot be similar.");
    ...
    */
    /*
      bool Molecule::add_atom(caviar2::interpreter::Parser *parser)
      {
    ...
    */
    ...
    {
      std::string object_name = "x";
      std::string out_file_name = "tools_molecule_" + object_name + ".xyz";
    ...
    bool Molecule::add_atom(const tools::Atom &a, const Vector3d<double> &p, const Vector3d<double> &v)
    {
    ...
    bool Molecule::add_atom(const tools::Atom &a)
    {
      unsigned int i = atoms.size();
      atoms.push_back(a);
      atoms[i].upper_level_molecule = this;
